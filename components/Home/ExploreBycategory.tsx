    ...
    return (
        <div className='flex items-center justify-center gap-7 flex-col w-full px-3 md:px-10 md:py-12 py-7 '>
            <div className='flex items-center sm:justify-between justify-center  w-full'>
                ...
                <span onClick={() => router.push('/category')} className="text-rheinland-yellow sm:flex items-center justify-center flex-wrap gap-3 cursor-pointer hidden ">
                    Show all Categories
                    <CiCircleChevRight />
                </span>
            </div>
            ...
            <span onClick={() => router.push('/category')} className=
            "text-rheinland-yellow flex items-center justify-center flex-wrap gap-2 cursor-pointer sm:hidden text-[18px] ">
                Show all Categories
                <CiCircleChevRight />
            </span>
        </div>
