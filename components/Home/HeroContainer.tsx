...
const HeroContainer = () => {
    ...
    return (
        <div className='flex items-center justify-center gap-5 pt-[80px] lg:px-16 px-5 md:px-5  min-h-[100vh]'>
            <div className='lg:w-1/2 w-full flex flex-col gap-5'>
                ...
                <div className="w-full lg:w-[70vw] flex items-center justify-end lg:flex-row flex-col gap-3 bg-slate-200 px-5 py-5 rounded-sm">
