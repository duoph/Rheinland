...
const CategoryCard = ({ category }: any) => {
  return (
    <Link href={`/category/${category?.id}`} className="border flex flex-col items-start justify-between w-full sm:w-[30vw] h-[130px] sm:h-[150px] group rounded-sm p-4 cursor-pointer hover:bg-rheinland-red hover:text-white transition-all duration-300 ease-in-out">
