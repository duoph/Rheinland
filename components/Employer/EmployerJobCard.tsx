    ...
    <div className="border shadow-sm border-opacity-35 flex gap-4 flex-col items-start justify-between md:min-w-[320px] w-full md:max-w-[320px] group cursor-pointer rounded-sm px-4 py-3">
      ...
      <div className="flex flex-col gap-2 text-gray-600 text-sm">
        ...
        <div className="flex items-center">
          ...
          <span className="ml-1">25 - 35</span>
        </div>
      </div>

      {/* Job Description */}
      <div className="flex flex-col gap-2 text-gray-700 text-sm">
        <p className="italic">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum perspiciatis odio facere illum itaque consectetur doloremque nobis distinctio accusamus! Voluptatum officia repellat non.</p>
      </div>
