    ...
    return (
        <>
            {job ? (
                ...
                <div className='border shadow-md flex flex-col items-center justify-center sm:min-w-[400px] w-full sm:max-w-[400px] min-h-[250px] max-h-[250px] group rounded-sm px-3 py-2 cursor-pointer bg-rheinland-blue'>
                    <p>Loading</p>
                </div>
            )}
        </>
