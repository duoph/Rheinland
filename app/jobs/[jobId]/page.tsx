...
const SingleJobPage = () => {
    ...
    if (error) {
        return <div className="relative min-h-screen flex items-center justify-center">{error}</div>
    }
    ...
    return (
        <div className="relative min-h-screen flex flex-col gap-3 items-center justify-start px-3 sm:px-5 pt-[90px]">
            ...
            <div className="flex flex-col items-start justify-center w-full gap-3">
                ...
                <div className='font-light text-sm text-white flex gap-2 flex-wrap pb-3'>
                    {job?.skills?.map((skill, index) => (
                        <span key={index} className='px-3 py-3 bg-rheinland-blue rounded-sm cursor-pointer'>{skill}</span>
            ...
            <div className="flex flex-col gap-2 items-start justify-center w-full">
                ...
                <p className='font-light'>{job?.description || 'No description available'}</p>
            </div>
